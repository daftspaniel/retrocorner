10 REM PIG DICE BY DAVY MITCHELL
30 REM (c)2011-2018
35 REM
...
49 CLEAR 700: BL$ = STRING$(32," "): BZ$ = STRING$(255," "):BS$=STRING$(32,CHR$(153)):C$=STRING$(7, 207)
...
2110 IF WH=1 THEN GOSUB 5000 ELSE GOSUB 6000
2180 IF RT=1 THEN GOSUB 3000:REM ROLL DICE
2280 IF RT=1 THEN GOTO 2101
2290 REM ROUND OVER
...
3000 REM
3010 REM dice
3020 PLAY "O3T255ABCDEF"
3026 PRINT@96, BZ$:PRINT@352, BL$;
3030 DX = 1 + RND(12):DY = 4
3035 GOSUB 4000
3038 RS=RS+DD:CR=DD
3040 DX = DX+8
3042 GOSUB 4000
...
3999 RETURN
4000 REM 
4006 DD = RND(6): CC=207:QQ=(DY*32)+DX+1024
4010 REM 
4020 REM 
4030 REM 
4040 REM 
...
4050 REM
4051 PRINT @B+DX, C$;
4052 PRINT @B+32+DX, C$;
4053 PRINT @B+64+DX, C$;
4054 PRINT @B+96+DX, C$;
4055 PRINT @B+128+DX, C$;
4056 PRINT @B+160+DX, C$;
4057 PRINT @B+192+DX, C$;
4068 IF DD = 1 OR DD = 5 OR DD = 3 THEN PRINT @B+96+DX+3, CHR$(128);
4069 IF DD = 4 OR DD = 5 OR DD = 6 THEN PRINT @B+32+DX+1, CHR$(128);:PRINT @B+32+DX+5, CHR$(128);
4080 IF DD = 6 THEN PRINT @B+96+DX+1, CHR$(128);:PRINT @B+96+DX+5, CHR$(128);
4082 IF DD = 4 OR DD = 5 OR DD = 6 THEN PRINT @B+160+DX+1, CHR$(128);:PRINT @B+160+DX+5, CHR$(128);
4085 IF DD = 3 OR DD = 2 THEN PRINT @B+32+DX+5, CHR$(128);:PRINT @B+160+DX+1, CHR$(128);
4500 RETURN
5000 REM
5003 REM USER
5005 PRINT @439, "total"+STR$(RSC)+"";
5010 IF AV=0 THEN PRINT @483, "r"+CHR$(255)+"TO"+CHR$(255)+"ROLL";:RT=3
5015 IF AV>0 THEN PRINT @499, "b"+CHR$(255)+"TO"+CHR$(255)+"BANK";:PRINT @417, "avoid"+STR$(AV);
5020 A$=INKEY$:IFA$=""THEN 5020
5030 IF A$="R" THEN RT=1
5035 IF AV>0 AND A$="B" THEN RT=2:PLAY "O4T255ABCDEF"
...
6005 REM 
6010 REM 
6012 PRINT @416, STRING$(95,CHR$(255))+"";:PRINT @440, "total"+STR$(RSC)+"";
